...
//As explained in Traderpc1 but for the second player

public class TRADERPCP2 : MonoBehaviour
{
    ...
    public TRADEP2 trade;
    public static TRADERPCP2 instance;
    ...
    void Start()
    {
        ...
        trade = FindObjectOfType<TRADEP2>();
    }
    ...
    public void TradeGoldberg()
    {
        ...
        else 
        {
            ...
            if(InputedInt > Money.moneyPlay1)
            {
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, GoldbergName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, QuinnName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, SangName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, SaeName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, GiName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, HolmesName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, WatsonName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, LestradeName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, HarryName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, DumbleName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, SnapeName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, SkywalkerName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, KenobiName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, SoloName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, ElevenName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, WheelerName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, HopperName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, SummerName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, MortyName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, RickName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, MyerName);
    }
    ...
    {
        Debug.Log(Value);
        TRADEACTIVEP1.instance.TradeAcceptP1(Value, StrodeName);
    }
