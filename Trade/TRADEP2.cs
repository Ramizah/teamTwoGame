...
//Same as explained in Trade1 but for player 2

public class TRADEP2 : MonoBehaviour
{
    public MoneySystem Money;
    public AudioManager Audio;
    public static TRADEP2 instance;
    ...
    public void Update()
    {
        ...
        if(Money.P2IsMine1 == true)
        {
            ShowCard1 = true;
        }
        if(Money.P2IsMine1 == false)
        {
            ShowCard1 = false;
        }

        if(Money.P2IsMine2 == true)
        {
            ShowCard2 = true;
        }
        if(Money.P2IsMine2 == false)
        {
            ShowCard2 = false;
        }

        if(Money.P2IsMine4 == true)
        {
            ShowCard3 = true;
        }
        if(Money.P2IsMine4 == false)
        {
            ShowCard3 = false;
        }

        if(Money.P2IsMine5 == true)
        {
            ShowCard4 = true;
        }
        if(Money.P2IsMine5 == false)
        {
            ShowCard4 = false;
        }

        if(Money.P2IsMine6 == true)
        {
            ShowCard5 = true;
        }
        if(Money.P2IsMine6 == false)
        {
            ShowCard5 = false;
        }

        if(Money.P2IsMine7 == true)
        {
            ShowCard6 = true;
        }
        if(Money.P2IsMine7 == false)
        {
            ShowCard6 = false;
        }

        if(Money.P2IsMine9 == true)
        {
            ShowCard7 = true;
        }
        if(Money.P2IsMine9 == false)
        {
            ShowCard7 = false;
        }

        if(Money.P2IsMine10 == true)
        {
            ShowCard8 = true;
        }
        if(Money.P2IsMine10 == false)
        {
            ShowCard8 = false;
        }

        if(Money.P2IsMine12 == true)
        {
            ShowCard9 = true;
        }
        if(Money.P2IsMine12 == false)
        {
            ShowCard9 = false;
        }

        if(Money.P2IsMine13 == true)
        {
            ShowCard10 = true;
        }
        if(Money.P2IsMine13 == false)
        {
            ShowCard10 = false;
        }

        if(Money.P2IsMine14 == true)
        {
            ShowCard11 = true;
        }
        if(Money.P2IsMine14 == false)
        {
            ShowCard11 = false;
        }

        if(Money.P2IsMine15 == true)
        {
            ShowCard12 = true;
        }
        if(Money.P2IsMine15 == false)
        {
            ShowCard12 = false;
        }

        if(Money.P2IsMine16 == true)
        {
            ShowCard13 = true;
        }
        if(Money.P2IsMine16 == false)
        {
            ShowCard13 = false;
        }

        if(Money.P2IsMine17 == true)
        {
            ShowCard14 = true;
        }
        if(Money.P2IsMine17 == false)
        {
            ShowCard14 = false;
        }

        if(Money.P2IsMine19 == true)
        {
            ShowCard15 = true;
        }
        if(Money.P2IsMine19 == false)
        {
            ShowCard15 = false;
        }

        if(Money.P2IsMine20 == true)
        {
            ShowCard16 = true;
        }
        if(Money.P2IsMine20 == false)
        {
            ShowCard16 = false;
        }

        if(Money.P2IsMine22 == true)
        {
            ShowCard17 = true;
        }
        if(Money.P2IsMine22 == false)
        {
            ShowCard17 = false;
        }

        if(Money.P2IsMine23 == true)
        {
            ShowCard18 = true;
        }
        if(Money.P2IsMine23 == false)
        {
            ShowCard18 = false;
        }

        if(Money.P2IsMine24 == true)
        {
            ShowCard19 = true;
        }
        if(Money.P2IsMine24 == false)
        {
            ShowCard19 = false;
        }

        if(Money.P2IsMine25 == true)
        {
            ShowCard20 = true;
        }
        if(Money.P2IsMine25 == false)
        {
            ShowCard20 = false;
        }

        if(Money.P2IsMine27 == true)
        {
            ShowCard21 = true;
        }
        if(Money.P2IsMine27 == false)
        {
            ShowCard21 = false;
        }

        if(Money.P2IsMine28 == true)
        {
            ShowCard22 = true;
        }
        if(Money.P2IsMine28 == false)
        {
            ShowCard22 = false;
        }
