...
public class Player1Money : MonoBehaviour
{
    ...
    //File deals with the node pathing of each property and when to activate and deactivate the propety functions within MoneySystem and other files

    //Landing on MiniGames also loads them from here to the Loading Canvas and then to the Minigame

    //Checks are present for whether the player is moving and if it is their turn, and also reactivates after the player has left the activation zone.
    ...
    void Update()
    {
        ...
        if(ID.ConstantID == 0)
        {
            ...
            {
                Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(0);
            ...
            {
                Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(100);
                Restart37 = false;
            }
        ...
        //----------------------Prop1------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(1);
                    Restart1 = false;
                }
                else if(Brought.isBrought1 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Goldberg Avenue");
                InfoProperty1.instance.PriceInfo("Property Price: 60");
                InfoProperty1.instance.SetInfo("Colour Set: Brown");
        ...
        //----------------------Prop2------------------------------//
            ...
            {   
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(2);
                    Restart2 = false;
                }
                else if(Brought.isBrought2 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Quinn Lane");
                InfoProperty1.instance.PriceInfo("Property Price: 60");
                InfoProperty1.instance.SetInfo("Colour Set: Brown");
        ...
        //----------------------Prop3------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(3);
                    Restart3 = false;
                }
                else if(Brought.isBrought3 == false)
                {
                    Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                    InfoProperty1.instance.StreetInfo("Property Name: Rogers Railway");
                    InfoProperty1.instance.PriceInfo("Property Price: 200");
                    InfoProperty1.instance.SetInfo("Colour Set: Station");
        ...
        //----------------------Prop4------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(4);
                    Restart4 = false;
                }
                else if(Brought.isBrought4 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Sang Woo Street");
                InfoProperty1.instance.PriceInfo("Property Price: 100");
                InfoProperty1.instance.SetInfo("Colour Set: Light Blue");
        ...
        //----------------------Prop5------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(5);
                    Restart5 = false;
                }
                else if(Brought.isBrought5 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Sae-Byeok");
                InfoProperty1.instance.PriceInfo("Property Price: 100");
                InfoProperty1.instance.SetInfo("Colour Set: Light Blue");
        ...
        //----------------------Prop6------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(6);
                    Restart6 = false;
                }
                else if(Brought.isBrought6 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Gi-Hun");
                InfoProperty1.instance.PriceInfo("Property Price: 120");
                InfoProperty1.instance.SetInfo("Colour Set: Light Blue");
        ...
        //----------------------Prop7------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(7);
                    Restart7 = false;
                }
                else if(Brought.isBrought7 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Holmes Road");
                InfoProperty1.instance.PriceInfo("Property Price: 140");
                InfoProperty1.instance.SetInfo("Colour Set: Pink");
        ...
        //----------------------Prop8------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(8);
                    Restart8 = false;
                }
                else if(Brought.isBrought8 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Stark Industries");
                InfoProperty1.instance.PriceInfo("Property Price: 150");
                InfoProperty1.instance.SetInfo("Colour Set: Industry");
        ...
        //----------------------Prop9------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(9);
                    Restart9 = false;
                }
                else if(Brought.isBrought9 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Watson Avenue");
                InfoProperty1.instance.PriceInfo("Property Price: 140");
                InfoProperty1.instance.SetInfo("Colour Set: Pink");
        ...
        //----------------------Prop10------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(10);
                    Restart10 = false;
                }
                else if(Brought.isBrought10 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Lestrade Lane");
                InfoProperty1.instance.PriceInfo("Property Price: 160");
                InfoProperty1.instance.SetInfo("Colour Set: Pink");
        ...
        //----------------------Prop11------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(11);
                    Restart11 = false;
                }
                else if(Brought.isBrought11 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Strange Railway");
                InfoProperty1.instance.PriceInfo("Property Price: 200");
                InfoProperty1.instance.SetInfo("Colour Set: Station");
        ...
        //----------------------Prop12------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(12);
                    Restart12 = false;
                }
                else if(Brought.isBrought12 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Potter Manor");
                InfoProperty1.instance.PriceInfo("Property Price: 180");
                InfoProperty1.instance.SetInfo("Colour Set: Orange");
        ...
        //----------------------Prop13------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(13);
                    Restart13 = false;
                }
                else if(Brought.isBrought13 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Dumbeldore Valley");
                InfoProperty1.instance.PriceInfo("Property Price: 180");
                InfoProperty1.instance.SetInfo("Colour Set: Orange");
        ...
        //----------------------Prop14------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(14);
                    Restart14 = false;
                }
                else if(Brought.isBrought14 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Snape Street");
                InfoProperty1.instance.PriceInfo("Property Price: 200");
                InfoProperty1.instance.SetInfo("Colour Set: Orange");
        ...
        //----------------------Prop15------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(15);
                    Restart15 = false;
                }
                else if(Brought.isBrought15 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: SkyWalker Boulevard");
                InfoProperty1.instance.PriceInfo("Property Price: 220");
                InfoProperty1.instance.SetInfo("Colour Set: Red");
        ...
        //----------------------Prop16------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(16);
                    Restart16 = false;
                }
                else if(Brought.isBrought16 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Kenobi Avenue");
                InfoProperty1.instance.PriceInfo("Property Price: 220");
                InfoProperty1.instance.SetInfo("Colour Set: Red");
        ...
        //----------------------Prop17------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(17);
                    Restart17 = false;
                }
                else if(Brought.isBrought17 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Solo Street");
                InfoProperty1.instance.PriceInfo("Property Price: 240");
                InfoProperty1.instance.SetInfo("Colour Set: Red");
        ...
        //----------------------Prop18------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(18);
                    Restart18 = false;
                }
                else if(Brought.isBrought18 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Kent Railways");
                InfoProperty1.instance.PriceInfo("Property Price: 200");
                InfoProperty1.instance.SetInfo("Colour Set: Station");
        ...
        //----------------------Prop19------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(19);
                    Restart19 = false;
                }
                else if(Brought.isBrought19 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Eleven Boulevard");
                InfoProperty1.instance.PriceInfo("Property Price: 260");
                InfoProperty1.instance.SetInfo("Colour Set: Yellow");
        ...
        //----------------------Prop20------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(20);
                    Restart20 = false;
                }
                else if(Brought.isBrought20 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Hopper Way");
                InfoProperty1.instance.PriceInfo("Property Price: 260");
                InfoProperty1.instance.SetInfo("Colour Set: Yellow");
        ...
        //----------------------Prop21------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(21);
                    Restart21 = false;
                }
                else if(Brought.isBrought21 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Wayne Industries");
                InfoProperty1.instance.PriceInfo("Property Price: 150");
                InfoProperty1.instance.SetInfo("Colour Set: Industry");
        ...
        //----------------------Prop22------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(22);
                    Restart22 = false;
                }
                else if(Brought.isBrought22 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Wheeler Highway");
                InfoProperty1.instance.PriceInfo("Property Price: 280");
                InfoProperty1.instance.SetInfo("Colour Set: Yellow");
        ...
        //----------------------Prop23------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(23);
                    Restart23 = false;
                }
                else if(Brought.isBrought23 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Summer Street");
                InfoProperty1.instance.PriceInfo("Property Price: 300");
                InfoProperty1.instance.SetInfo("Colour Set: Green");
        ...
        //----------------------Prop24------------------------------//
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(24);
                    Restart24 = false;
                }
                else if(Brought.isBrought24 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Morty Manor");
                InfoProperty1.instance.PriceInfo("Property Price: 300");
                InfoProperty1.instance.SetInfo("Colour Set: Green");
        ...
        //----------------------Prop25------------------------------//   
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(25);
                    Restart25 = false;
                }
                else if(Brought.isBrought25 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Ricks Road");
                InfoProperty1.instance.PriceInfo("Property Price: 320");
                InfoProperty1.instance.SetInfo("Colour Set: Green");
        ...
        //----------------------Prop26------------------------------//  
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(26);
                    Restart26 = false;
                }
                else if(Brought.isBrought26 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Curry Railway");
                InfoProperty1.instance.PriceInfo("Property Price: 200");
                InfoProperty1.instance.SetInfo("Colour Set: Station");
        ...
        //----------------------Prop27------------------------------//    
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(27);
                    Restart27 = false;
                }
                else if(Brought.isBrought27 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Myers Manor");
                InfoProperty1.instance.PriceInfo("Property Price: 350");
                InfoProperty1.instance.SetInfo("Colour Set: Dark Blue");
        ...
        //----------------------Prop28------------------------------//  
...

            {
                ...
                {
                    Money.GetComponent<MoneySystem>().MONEY_CONTROLLER(28);
                    Restart28 = false;
                }
                else if(Brought.isBrought28 == false)
                {
                Yes.SetActive(true); No.SetActive(true); CheckStructure.SetActive(true);
                InfoProperty1.instance.StreetInfo("Property Name: Strode Street");
                InfoProperty1.instance.PriceInfo("Property Price: 400");
                InfoProperty1.instance.SetInfo("Colour Set: Dark Blue");
    ...
    {
        Vector3 prevPos = player1.transform.position;
        yield return new WaitForSeconds(0.2f);
        Vector3 actualPos = player1.transform.position;
