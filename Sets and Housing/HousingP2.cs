...
//Example of file similarly explained within HousingP1

public class HousingP2 : MonoBehaviour
{
    ...
    {
        Audio.Play("Money");
        if(Count1 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite1();
            RPC1();
            return;
        }
        if(Count1 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite1();
            RPC1();
            return;
        }
        if(Count1 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite1();
            RPC1();
            return;
        }
        if(Count1 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite1();
            RPC1();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count2 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite2();
            RPC2();
            return;
        }
        if(Count2 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite2();
            RPC2();
            return;
        }
        if(Count2 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite2();
            RPC2();
            return;
        }
        if(Count2 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite2();
            RPC2();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count3 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite3();
            RPC3();
            return;
        }
        if(Count3 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite3();
            RPC3();
            return;
        }
        if(Count3 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite3();
            RPC3();
            return;
        }
        if(Count3 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite3();
            RPC3();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count4 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite4();
            RPC4();
            return;
        }
        if(Count4 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite4();
            RPC4();
            return;
        }
        if(Count4 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite4();
            RPC4();
            return;
        }
        if(Count4 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite4();
            RPC4();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count5 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite5();
            RPC5();
            return;
        }
        if(Count5 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite5();
            RPC5();
            return;
        }
        if(Count5 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite5();
            RPC5();
            return;
        }
        if(Count5 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite5();
            RPC5();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count6 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite6();
            RPC6();
            return;
        }
        if(Count6 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite6();
            RPC6();
            return;
        }
        if(Count6 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite6();
            RPC6();
            return;
        }
        if(Count6 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite6();
            RPC6();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count7 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite7();
            RPC7();
            return;
        }
        if(Count7 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite7();
            RPC7();
            return;
        }
        if(Count7 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite7();
            RPC7();
            return;
        }
        if(Count7 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite7();
            RPC7();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count8 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite8();
            RPC8();
            return;
        }
        if(Count8 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite8();
            RPC8();
            return;
        }
        if(Count8 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite8();
            RPC8();
        ...
        if(Count8 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite8();
            RPC8();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count9 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite9();
            RPC9();
            return;
        }
        if(Count9 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite9();
            RPC9();
            return;
        }
        if(Count9 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite9();
            RPC9();
            return;
        }
        if(Count9 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite9();
            RPC9();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count10 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite10();
            RPC10();
            return;
        }
        if(Count10 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite10();
            RPC10();
            return;
        }
        if(Count10 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite10();
            RPC10();
            return;
        }
        if(Count10 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite10();
            RPC10();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count11 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite11();
            RPC11();
            return;
        }
        if(Count11 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite11();
            RPC11();
            return;
        }
        if(Count11 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite11();
            RPC11();
            return;
        }
        if(Count11 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite11();
            RPC11();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count12 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite12();
            RPC12();
            return;
        }
        if(Count12 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite12();
            RPC12();
            return;
        }
        if(Count12 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite12();
            RPC12();
            return;
        }
        if(Count12 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite12();
            RPC12();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count13 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite13();
            RPC13();
            return;
        }
        if(Count13 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite13();
            RPC13();
            return;
        }
        if(Count13 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite13();
            RPC13();
            return;
        }
        if(Count13 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite13();
            RPC13();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count14 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite14();
            RPC14();
            return;
        }
        if(Count14 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite14();
            RPC14();
            return;
        }
        if(Count14 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite14();
            RPC14();
            return;
        }
        if(Count14 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite14();
            RPC14();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count15 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite15();
            RPC15();
            return;
        }
        if(Count15 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite15();
            RPC15();
            return;
        }
        if(Count15 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite15();
            RPC15();
            return;
        }
        if(Count15 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite15();
            RPC15();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count16 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite16();
            RPC16();
            return;
        }
        if(Count16 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite16();
            RPC16();
            return;
        }
        if(Count16 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite16();
            RPC16();
            return;
        }
        if(Count16 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite16();
            RPC16();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count17 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite17();
            RPC17();
            return;
        }
        if(Count17 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite17();
            RPC17();
            return;
        }
        if(Count17 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite17();
            RPC17();
            return;
        }
        if(Count17 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite17();
            RPC17();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count18 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite18();
            RPC18();
            return;
        }
        if(Count18 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite18();
            RPC18();
            return;
        }
        if(Count18 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite18();
            RPC18();
            return;
        }
        if(Count18 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite18();
            RPC18();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count19 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite19();
            RPC19();
            return;
        }
        if(Count19 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite19();
            RPC19();
            return;
        }
        if(Count19 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite19();
            RPC19();
            return;
        }
        if(Count19 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite19();
            RPC19();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count20 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite20();
            RPC20();
            return;
        }
        if(Count20 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite20();
            RPC20();
            return;
        }
        if(Count20 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite20();
            RPC20();
            return;
        }
        if(Count20 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite20();
            RPC20();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count21 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite21();
            RPC21();
            return;
        }
        if(Count21 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite21();
            RPC21();
            return;
        }
        if(Count21 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite21();
            RPC21();
            return;
        }
        if(Count21 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite21();
            RPC21();
            return;
    ...
    {
        Audio.Play("Money");
        if(Count22 == 0 && Money.moneyPlay2 > 50)
        {
            ActiveSite22();
            RPC22();
            return;
        }
        if(Count22 == 1 && Money.moneyPlay2 > 50)
        {
            ActiveSite22();
            RPC22();
            return;
        }
        if(Count22 == 2 && Money.moneyPlay2 > 50)
        {
            ActiveSite22();
            RPC22();
            return;
        }
        if(Count22 == 3 && Money.moneyPlay2 > 50)
        {
            ActiveSite22();
            RPC22();
            return;
    ...
    public void ActiveSite10()
    {
        if(Count10 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(10);
            Site10House1 = true;
            Money.moneyPlay2 -= 50;
            Count10 = 1;
            return;
    ...
    public void ActiveSite11()
    {
        if(Count11 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(11);
            Site11House1 = true;
            Money.moneyPlay2 -= 50;
            Count11 = 1;
            return;
    ...
    public void ActiveSite12()
    {
        if(Count12 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(12);
            Site12House1 = true;
            Money.moneyPlay2 -= 50;
            Count12 = 1;
            return;
    ...
    public void ActiveSite13()
    {
        if(Count13 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(13);
            Site13House1 = true;
            Money.moneyPlay2 -= 50;
            Count13 = 1;
            return;
    ...
    public void ActiveSite14()
    {
        if(Count14 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(14);
            Site14House1 = true;
            Money.moneyPlay2 -= 50;
            Count14 = 1;
            return;
    ...
    public void ActiveSite15()
    {
        if(Count15 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(15);
            Site15House1 = true;
            Money.moneyPlay2 -= 50;
            Count15 = 1;
            return;
    ...
    public void ActiveSite16()
    {
        if(Count16 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(16);
            Site16House1 = true;
            Money.moneyPlay2 -= 50;
            Count16 = 1;
            return;
    ...
    public void ActiveSite17()
    {
        if(Count17 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(17);
            Site17House1 = true;
            Money.moneyPlay2 -= 50;
            Count17 = 1;
            return;
    ...
    public void ActiveSite18()
    {
        if(Count18 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(18);
            Site18House1 = true;
            Money.moneyPlay2 -= 50;
            Count18 = 1;
            return;
    ...
    public void ActiveSite19()
    {
        if(Count19 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(19);
            Site19House1 = true;
            Money.moneyPlay2 -= 50;
            Count19 = 1;
            return;
    ...
    public void ActiveSite20()
    {
        if(Count20 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(20);
            Site20House1 = true;
            Money.moneyPlay2 -= 50;
            Count20 = 1;
            return;
    ...
    public void ActiveSite21()
    {
        if(Count21 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(21);
            Site21House1 = true;
            Money.moneyPlay2 -= 50;
            Count21 = 1;
            return;
    ...
    public void ActiveSite22()
    {
        if(Count22 == 0)
        {
            ...
            TRADERPCP2.instance.NoTrade(22);
            Site22House1 = true;
            Money.moneyPlay2 -= 50;
            Count22 = 1;
            return;
